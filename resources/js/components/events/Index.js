    ...
    render () {
        ...
        return (
            <div className='main-content-container container-fluid px-4'>
                ...
                <div className='col'>
                    <TableProvider keyField='id' columns={ columns } data={ events } bootstrap4 search>
                        {
                            props => (
                                <div>
                                    <div className='row mb-3'>
                                        <div className='col-3 col-md-6 col-lg-3'>
                                            <Link to='/app/events/create' className='btn btn-primary'>Create</Link>
                                        </div>
                                        ...
                                        <Table
                                            ...
                                            rowEvents={ {
                                                onClick: (e, row, rowIndex) => {
                                                    this.props.history.push(`/app/events/${ row.id }`);
                                                },
                                              } }
